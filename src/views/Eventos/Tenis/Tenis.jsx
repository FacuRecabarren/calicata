  ...
  return (
    <div className='bg-[#f2f2f2]'>
      <div className='relative'>
        <img src="https://res.cloudinary.com/dreso9ye9/image/upload/v1712013033/darko-nesic-VZEnVM6c1lY-unsplash_dfozbj.jpg" alt="" className='h-[25rem] w-full object-cover object-center'/>
        <h2 className='text-center w-full py-2 px-4 text-white font-bold text-2xl sm:text-3xl shadow-xl bg-[#000000] bg-opacity-80 absolute bottom-0'>{t("tennisPackages")}</h2>
