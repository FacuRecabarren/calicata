    ...
    return (
        <div className='flex flex-col justify-center items-start'>
            <div className='relative w-full'>
                <img loading='lazy' src={paqueteDetail.coverImage} alt="Imagen principal" className='object-cover h-[25rem] w-full -z-10 brightness-75'/>
                <div className='absolute z-10 top-[50%] sm:left-5 flex flex-col sm:justify-start sm:items-start justify-center items-center gap-2 sm:px-0 px-5'>
                    ...
                    <p className='hidden lg:block absolute -bottom-10 text-[#FCCC71] text-xl cursor-default uppercase'><Link to="/sports/tennis" className='z-50 text-white hover:text-[#bcbec7] duration-300 hover:underline'>{t("tennisPackages")}</Link> / {paqueteDetail.title}</p>
                </div>
            </div>
