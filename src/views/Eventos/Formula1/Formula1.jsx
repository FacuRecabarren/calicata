  ...
  return (
    <div className='bg-[#f2f2f2]'>
      <div className='relative'>
        <img loading='lazy' src="https://res.cloudinary.com/dreso9ye9/image/upload/v1709307319/Fo_CC_81rmula_1_Red_Bull-1390432726_stjwz5.webp" alt="" className='h-[25rem] w-full object-cover object-center'/>
          <h1 className='m-0 text-center w-full py-2 px-4 text-white font-bold text-2xl sm:text-3xl shadow-xl bg-[#000000] bg-opacity-80 absolute bottom-0'>{t("formula1Packages")}</h1>
