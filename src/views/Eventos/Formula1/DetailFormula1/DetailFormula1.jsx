        ...
        <div className='flex flex-col justify-center items-start'>
            ...
            <div className='py-10 px-10 w-full flex justify-between items-start gap-16'>
                <section className='w-[40%] flex flex-col justify-center items-start gap-4'>
                    ...
                    <article className='flex flex-col gap-2 w-full'>
                        ...
                        <div className='flex flex-col gap-2'>
                            <div className='flex justify-start items-center gap-2 border border-[#FE904D] rounded-r-xl w-full'>
                                <div className='bg-[#FE904D] text-xl text-white p-2'>
                                    <IoIosPeople/>
                                </div>
                ...
                <section className='flex flex-col justify-center items-start gap-3 w-full'>
                    ...
                    <div className='flex justify-start items-center gap-3 border border-[#FE904D] rounded-r-xl w-full'>
                        <div className='bg-[#FE904D] text-xl text-white p-3'>
                            <LuCalendarClock/>
                        </div>
