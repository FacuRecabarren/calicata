    ...
    <div id='servicios' className='pt-20 relative lg:bg-[url(https://res.cloudinary.com/dreso9ye9/image/upload/v1709125624/Group_13_1_vgyvfn.svg)] bg-cover bg-no-repeat bg-bottom bg-[url(https://res.cloudinary.com/dreso9ye9/image/upload/v1709083896/Group_13_zsavu4.svg)]'>
      <div className='flex flex-col justify-center items-center gap-10 lg:gap-10 px-10 pb-10'>
        ...
        <div className='flex flex-col lg:flex lg:flex-row justify-center items-center w-full gap-5'>
          ...
          <div data-aos='fade-up' className='w-full h-full bg-white rounded-xl shadow-xl'>
            <div className="transform hover:scale-[1.02] duration-300 rounded-xl h-[25rem] z-10 flex flex-col justify-center items-center gap-4 w-full bg-[url('https://res.cloudinary.com/dreso9ye9/image/upload/v1709915165/premium_photo-1661963952208-2db3512ef3de_vtsp8w.webp')] bg-cover bg-center">
              <div className="z-10 flex flex-col justify-between items-center gap-4 w-full h-full">
                <p className="text-xl sm:text-2xl text-white font-bold text-center w-full bg-[#FE904D] py-2 rounded-t-xl shadow-xl">{t('travel1')}</p>
                <Link to="/travel" className="text-md sm:text-xl flex justify-center items-center gap-2 bg-[#FE904D] absolute bottom-0 py-4 px-8 font-bold rounded-t-xl text-white hover:text-white hover:bg-opacity-50 border-4 border-[#FE904D] duration-500">{t("packages1")}</Link>
              </div>
            </div>
          </div>
        </div>
