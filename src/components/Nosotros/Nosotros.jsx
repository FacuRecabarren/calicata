      ...
      <div id='nosotros' className="py-36 bg-white">
        ...
        <div className="flex justify-center lg:flex-row lg:justify-between lg:items-center relative">
            <img
                ...
                alt=""
                className="w-[18rem] absolute left-0 top-0 z-10"
            />
            <section className='h-full flex flex-col gap-5 items-center justify-center'>
                ...
                <p className='text-gray-400 font-lora italic text-center font-semibold leading-loose text-[18px] w-[70%] z-20'>{text}</p>
            </section>
            <img
                src="https://res.cloudinary.com/dreso9ye9/image/upload/v1709126761/Vector_4_xurgbc.svg"
                alt=""
                className="w-[18rem] absolute right-0 top-0 z-10"
            />
          </div>
        </div>
    );
