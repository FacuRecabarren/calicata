  ...
  return (
    <div className="accent-[#218B7D] w-[25rem] flex flex-col justify-center items-start gap-4 bg-white p-5 shadow-xl rounded-xl border-t-8 border-[#FE904D]">
      ...
      <article className='flex justify-between items-center w-full border-2 gap-1 border-[#218B7D] rounded-r-xl focus:outline-none focus:border-[#218B7D]'>
        ...
        <select id="country" onChange={(e) => handleInputChange(e, 'country')} className='opacity-80 font-medium text-sm font-lora italic focus:outline-none w-full'>
      ...
      <article className='flex justify-between items-center w-full border-2 border-[#218B7D] rounded-r-xl'>
        ...
        <input className='mr-2' type="checkbox" id="oneNight" onChange={(e) => handleInputChange(e, 'oneNight')} checked={filters.oneNight} />
      </article>
      <article className='flex justify-between items-center w-full border-2 border-[#218B7D] rounded-r-xl'>
        <div className='flex justify-center items-center gap-2'>
          <div className='p-2 bg-[#218B7D] text-white'>
        ...
        <input className='mr-2' type="checkbox" id="moreThanOneNight" onChange={(e) => handleInputChange(e, 'moreThanOneNight')} checked={filters.moreThanOneNight} />
      </article>
      <article className='flex justify-between items-center w-full border-2 border-[#218B7D] rounded-r-xl'>
        <div className='flex justify-center items-center gap-2'>
          <div className='p-2 bg-[#218B7D] text-white'>
        ...
        <input className='mr-2' type="checkbox" id="oneLodgings" onChange={(e) => handleInputChange(e, 'oneLodgings')} checked={filters.oneLodgings} />
      </article>
      <article className='flex justify-between items-center w-full border-2 border-[#218B7D] rounded-r-xl'>
        <div className='flex justify-center items-center gap-2'>
          <div className='p-2 bg-[#218B7D] text-white'>
        ...
        <input className='mr-2' type="checkbox" id="moreThanOneLodgings" onChange={(e) => handleInputChange(e, 'moreThanOneLodgings')} checked={filters.moreThanOneLodgings} />
      </article>
      <article className='flex justify-between items-center w-full border-2 border-[#218B7D] rounded-r-xl'>
        <div className='flex justify-center items-center gap-2'>
          <div className='p-2 bg-[#218B7D] text-white'>
        ...
        <input className='mr-2' type="checkbox" id="lessThan1500" onChange={(e) => handleInputChange(e, 'lessThan1500')} checked={filters.lessThan1500} />
      </article>
      <article className='flex justify-between items-center w-full border-2 border-[#218B7D] rounded-r-xl'>
        <div className='flex justify-center items-center gap-2'>
          <div className='p-2 bg-[#218B7D] text-white'>
        ...
        <input className='mr-2' type="checkbox" id="moreThan1500" onChange={(e) => handleInputChange(e, 'moreThan1500')} checked={filters.moreThan1500} />
      </article>
    </div>
  );
};
